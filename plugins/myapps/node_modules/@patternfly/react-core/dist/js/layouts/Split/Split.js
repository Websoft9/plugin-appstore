...
const Split = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({}, props, { className: (0, react_styles_1.css)(split_1.default.split, hasGutter && split_1.default.modifiers.gutter, isWrappable && split_1.default.modifiers.wrap, className) }), children));
};
exports.Split = Split;
