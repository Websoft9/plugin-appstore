...
class DropdownToggleAction extends React.Component {
    render() {
        ...
        return (React.createElement("button", Object.assign({ id: id, className: (0, react_styles_1.css)(dropdown_1.default.dropdownToggleButton, className), onClick: onClick }, (isDisabled && { disabled: true, 'aria-disabled': true }), props), children));
    }
}
