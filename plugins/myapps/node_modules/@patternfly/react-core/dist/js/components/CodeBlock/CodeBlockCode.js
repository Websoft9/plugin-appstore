...
const CodeBlockCode = (_a) => {
    ...
    return (React.createElement("pre", Object.assign({ className: (0, react_styles_1.css)(code_block_1.default.codeBlockPre, className) }, props),
        React.createElement("code", { className: (0, react_styles_1.css)(code_block_1.default.codeBlockCode, codeClassName) }, children)));
};
