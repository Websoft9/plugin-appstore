...
const PopoverDialog = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(popover_1.default.popover, popover_1.default.modifiers[position] || popover_1.default.modifiers.top, className), role: "dialog", "aria-modal": "true" }, props), children));
};
