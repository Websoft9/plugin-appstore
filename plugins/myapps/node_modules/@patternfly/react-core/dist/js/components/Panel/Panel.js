...
const PanelBase = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(panel_1.default.panel, variant === 'raised' && panel_1.default.modifiers.raised, variant === 'bordered' && panel_1.default.modifiers.bordered, isScrollable && panel_1.default.modifiers.scrollable, className), ref: innerRef }, props), children));
};
