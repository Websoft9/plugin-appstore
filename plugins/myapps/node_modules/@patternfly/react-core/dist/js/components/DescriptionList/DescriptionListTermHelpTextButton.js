...
const DescriptionListTermHelpTextButton = (_a) => {
    ...
    return (React.createElement("span", Object.assign({ className: (0, react_styles_1.css)(className, description_list_1.default.descriptionListText, description_list_1.default.modifiers.helpText), role: "button", type: "button", tabIndex: 0 }, props), children));
};
