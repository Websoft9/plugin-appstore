...
const MastheadBrand = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(masthead_1.default.mastheadBrand, className), tabIndex: 0 }, props), children));
};
