...
const ContextSelectorFooter = (_a) => {
    ...
    return (React.createElement("div", Object.assign({}, props, { className: (0, react_styles_1.css)(context_selector_1.default.contextSelectorMenuFooter, className) }), children));
};
