...
const DescriptionListTerm = (_a) => {
    ...
    return (React.createElement("dt", Object.assign({ className: (0, react_styles_1.css)(description_list_1.default.descriptionListTerm, className) }, props),
        icon ? React.createElement("span", { className: (0, react_styles_1.css)(description_list_1.default.descriptionListTermIcon) }, icon) : null,
        React.createElement("span", { className: (0, react_styles_1.css)(description_list_1.default.descriptionListText) }, children)));
};
