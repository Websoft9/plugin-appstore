...
const Divider = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(divider_1.default.divider, isVertical && divider_1.default.modifiers.vertical, (0, util_1.formatBreakpointMods)(inset, divider_1.default), (0, util_1.formatBreakpointMods)(orientation, divider_1.default), className) }, (component !== 'hr' && { role: 'separator' }), props)));
};
