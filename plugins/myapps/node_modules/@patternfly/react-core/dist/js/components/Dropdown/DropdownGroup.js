...
const DropdownGroup = (_a) => {
    ...
    return (React.createElement(dropdownConstants_1.DropdownContext.Consumer, null, ({ sectionClass, sectionTitleClass, sectionComponent }) => {
        ...
        return (React.createElement(SectionComponent, Object.assign({ className: (0, react_styles_1.css)(sectionClass, className) }, props),
            label && (React.createElement("h1", { className: (0, react_styles_1.css)(sectionTitleClass), "aria-hidden": true }, label)),
