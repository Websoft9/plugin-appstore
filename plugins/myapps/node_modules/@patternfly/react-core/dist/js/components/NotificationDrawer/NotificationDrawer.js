...
const NotificationDrawerBase = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ ref: innerRef }, props, { className: (0, react_styles_1.css)(notification_drawer_1.default.notificationDrawer, className) }), children));
};
