    ...
    constructor() {
        ...
        this.createSearchBox = () => {
            ...
            return (React.createElement("div", { key: "search", className: (0, react_styles_1.css)(app_launcher_1.default.appLauncherMenuSearch) },
                React.createElement(ApplicationLauncherItem_1.ApplicationLauncherItem, { customChild: React.createElement("input", Object.assign({ type: "search", className: (0, react_styles_1.css)(form_control_1.default.formControl), placeholder: searchPlaceholderText, onChange: e => onSearch(e.target.value) }, searchProps)) })));
        };
    }
    render() {
        ...
        favoritesLabel, searchNoResultsText, menuAppendTo, removeFindDomNode, zIndex = 9999 } = _a, props = tslib_1.__rest(_a, ['aria-label', "isOpen", "onToggle", "toggleIcon", "toggleId", "onSelect", "isDisabled", "className", "isGrouped", "favorites", "onFavorite", "onSearch", "items", "searchPlaceholderText", "searchProps", "ref", "favoritesLabel", "searchNoResultsText", "menuAppendTo", "removeFindDomNode", "zIndex"]);
        let renderableItems = [];
        if (onFavorite) {
            let favoritesGroup = [];
