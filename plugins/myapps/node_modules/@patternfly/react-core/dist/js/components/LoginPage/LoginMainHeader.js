...
const LoginMainHeader = (_a) => {
    ...
    return (React.createElement("header", Object.assign({ className: (0, react_styles_1.css)(login_1.default.loginMainHeader, className) }, props),
        title && (React.createElement(Title_1.Title, { headingLevel: "h2", size: Title_1.TitleSizes['3xl'] }, title)),
        subtitle && React.createElement("p", { className: (0, react_styles_1.css)(login_1.default.loginMainHeaderDesc) }, subtitle),
        headerUtilities && React.createElement("div", { className: (0, react_styles_1.css)(login_1.default.loginMainHeaderUtilities) }, headerUtilities),
        children));
};
