...
const DataListText = (_a) => {
    ...
    const text = (React.createElement(Component, Object.assign({ onMouseEnter: onMouseEnter, className: (0, react_styles_1.css)(className, wrapModifier && data_list_1.default.modifiers[wrapModifier], data_list_1.default.dataListText) }, props), children));
