...
const TreeViewSearch = (_a) => {
    ...
    return (React.createElement("div", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewSearch, className) },
        React.createElement("input", Object.assign({ className: (0, react_styles_1.css)(form_control_1.default.formControl, form_control_1.default.modifiers.search), onChange: onSearch, id: id, name: name, "aria-label": ariaLabel, type: "search" }, props))));
};
