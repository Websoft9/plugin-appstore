...
const FormHelperText = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(form_1.default.formHelperText, isError && form_1.default.modifiers.error, isHidden && form_1.default.modifiers.hidden, className) }, props),
        icon && React.createElement("span", { className: (0, react_styles_1.css)(form_1.default.formHelperTextIcon) }, icon),
        children));
};
