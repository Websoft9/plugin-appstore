...
const AboutModalBox = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ role: "dialog", "aria-modal": "true", className: (0, react_styles_1.css)(about_modal_box_1.default.aboutModalBox, className) }, props), children));
};
