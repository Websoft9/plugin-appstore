...
const NotificationDrawerGroupList = (_a) => {
    ...
    return (React.createElement("div", Object.assign({}, props, { className: (0, react_styles_1.css)(notification_drawer_1.default.notificationDrawerGroupList, className) }), children));
};
