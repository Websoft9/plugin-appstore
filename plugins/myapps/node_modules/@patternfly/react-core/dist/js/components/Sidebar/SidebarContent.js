...
const SidebarContent = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(sidebar_1.default.sidebarContent, hasNoBackground && sidebar_1.default.modifiers.noBackground, className) }, props), children));
};
