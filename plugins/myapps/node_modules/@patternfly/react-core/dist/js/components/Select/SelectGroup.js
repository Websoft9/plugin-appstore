...
const SelectGroup = (_a) => {
    ...
    return (React.createElement(selectConstants_1.SelectConsumer, null, ({ variant }) => (React.createElement("div", Object.assign({}, props, { className: (0, react_styles_1.css)(select_1.default.selectMenuGroup, className) }),
        React.createElement("div", { className: (0, react_styles_1.css)(select_1.default.selectMenuGroupTitle), id: titleId, "aria-hidden": true }, label),
