...
const InputGroupText = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(input_group_1.default.inputGroupText, variant === InputGroupTextVariant.plain && input_group_1.default.modifiers.plain, className) }, props), children));
};
