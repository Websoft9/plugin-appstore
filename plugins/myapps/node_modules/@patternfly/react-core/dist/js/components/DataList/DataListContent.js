...
const DataListContent = (_a) => {
    ...
    return (React.createElement("section", Object.assign({ id: id, className: (0, react_styles_1.css)(data_list_1.default.dataListExpandableContent, className), hidden: isHidden, "aria-label": ariaLabel }, props),
        React.createElement("div", { className: (0, react_styles_1.css)(data_list_1.default.dataListExpandableContentBody, hasNoPadding && data_list_1.default.modifiers.noPadding) }, children)));
};
